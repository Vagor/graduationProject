<template>
  <div>
    ...
    <mt-cell :title="item.paperTitle | characterLimit" value="" is-link class="left" :to="{ name: 's_paperChecked', params: { paperId: item.answerPaperId }}" v-for="item in AnswerCheckPaperList"></mt-cell>
